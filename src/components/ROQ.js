...
const ROQModel = () => {
  ...
  const handleSubmit = async (evt) => {
    ...
    let data = {
      ...
      leadTime: formInput["leadTime"],
      responseDate: formInput["responseDate"],
      email: formInput["email"],
      additionalInformation: formInput["additionalInformation"],
      phoneNumber: formInput["phoneNumber"],
      endUser: formInput["endUser"],
      additional: formInput["additional"],
      address: formInput["address"],
    };

    try {
      const response = await axios.post(`${API_URL}/api/v1/rfq`, data);
      toast.success("RFQ submitted successfully!");
      handleClose();
    } catch (error) {
      toast.error("Failed to submit RFQ. Please try again later.");
      ...
      <Modal open={open} onClose={handleClose}>
        <div className="modal-container">
          ...
          <div class="text-center">
            <Typography variant="h5">Quick RFQ</Typography>
          </div>
          <br />
          <div class="container">
            <form onSubmit={handleSubmit}>
              ...
              <div class="row">
                ...
                <div class="col-2">
                  <Button type="submit" style={{ left: "-3vw" }}>
                    Submit
                  </Button>{" "}
                </div>
              </div>
