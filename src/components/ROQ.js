...
//   };
  return (
    <div>
 <Button variant="contained" style={{maxWidth: '5vh', maxHeight: '4vh', minWidth: '2vh', minHeight: '2vh',borderRadius:"50%",position:'fixed',bottom:"20vh",right:"5vw",background:"green",zIndex:"2"}} onClick={handleOpen}><svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<Modal open={open} onClose={handleClose}>
  ...
  <div class="col-2"> <Button variant='outlined' onClick={handleClose}style={{left:"-5vw",background:"white",color:"green"}}>Close</Button></div>
		<div class="col-2">    <Button onClick={handleClose} style={{left:"-3vw"}}>Submit</Button>   </div>
